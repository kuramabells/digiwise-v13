...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2025 at 03:18 PM
...
ALTER TABLE `answers`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `answers_question_assessment_unique` (`question_id`,`assessment_id`),
  ADD KEY `question_id` (`question_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `answers_assessment_id_foreign_idx` (`assessment_id`);
...
--
ALTER TABLE `answers`
  ADD CONSTRAINT `answers_assessment_id_foreign_idx` FOREIGN KEY (`assessment_id`) REFERENCES `assessments` (`id`),
